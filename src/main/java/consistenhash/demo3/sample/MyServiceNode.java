...
import consistenhash.demo3.ConsistentHashRouter;
import consistenhash.demo3.Node;
...
public class MyServiceNode implements Node {
    ...
    public static void main(String[] args) {
        ...
        // new Thread(() -> goRoute(consistentHashRouter,requestIP1,requestIP2,requestIP3,requestIP4,requestIP5)).start();
