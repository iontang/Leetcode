...
public class MaxEnvelopes {
    ...
    // 状态：main.java.dp[0][0] =0, main.java.dp[0][1] =0;
...
//		int[] main.java.dp = new int[envelopes.length];
//		int len = 0;
//		for (int[] envelope : envelopes) {
//			int index = Arrays.binarySearch(main.java.dp, 0, len, envelope[1]);
//			if (index < 0) {
//				index = -index - 1;
//			}
//			main.java.dp[index] = envelope[1];
//			if (index == len)
//				len++;
//		}
//		return len;
